...
const Contact = () => {
  return (
    <>
      <Layout>
        <div className="min-h-screen bg-[#EFE4DB] pb-10 text-black overflow-auto md:overflow-hidden pt-[120px] lg:pt-[220px]">
          <div className="container mx-auto flex w-full flex-col items-start justify-center gap-[30px] lg:flex-row lg:items-center lg:justify-start lg:gap-[120px] lg:pt-8">
