  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1800px] px-4 sm:px-4 lg:px-4">
        {/* Mobile / tablet: hamburger + logo, then editorial stack */}
        ...
        {/* Desktop: three-column editorial bar */}
        {!isOpen && (
          <div className="hidden gap-6 lg:flex justify-between items-start xl:gap-y-10">
            ...
            <div className="grid self-start grid-cols-2 gap-6 -mt-6 max-w-[35%]">
              <div className="min-w-0">
                ...
                <ul
                  className={`mt-6 flex flex-col gap-2 font-inter text-xs ${editorialLink}`}
                >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="absolute top-full right-0 left-0 z-[9999] h-screen w-full overflow-hidden bg-[#EFE4DB]"
      ...
      {/* Soft fade at header bottom edge */}
      {!isHome && (
